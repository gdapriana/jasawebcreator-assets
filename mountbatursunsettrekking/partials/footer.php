    ...
    <div class="container-global pb-4 wow fadeInUp" style="position: relative; z-index: 3;">
        ...
        <div class="row justify-content-center wow fadeIn" data-wow-duration="2s">
            ...
            <div class="col-md-6 mb-4 mb-md-0">
                ...
                <p class="text-foot">stress-free!</p>
            ...
            <div class="col-md-3 mb-4 mb-md-0">
                ...
                <div class="list-sosmed mt-3">
                    <a href="<?= $data->social->facebook_url ?>"><img class="img-sosmed" src="https://jwc.gotra-resources.my.id/web-upload/1732441677-24-11-2024-0FtsPe5j3oblMECd1JpSr8UIXnmN6OgV.svg" alt="Facebook Logo"></a>

                    <a href="<?= $data->social->instagram_url ?>"><img class="img-sosmed" src="https://jwc.gotra-resources.my.id/web-upload/1732441677-24-11-2024-duE56KrGgHl392UCvcWxsmfRo1FYzXkn.webp" alt="Instagram Logo"></a>
                </div>
