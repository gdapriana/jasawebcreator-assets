...
<form id="contactForm" action="https://secure-booking.gotrabook.com/direct" method="POST">
	...
	<div class="form-row">
		<div class="form-group col-6">
			<label>Name</label>
			<input type="text" value="" data-msg-required="Your Name" maxlength="100" class="form-control" name="name" id="name">
		</div>
		<div class="form-group col-6">
			<label>Email</label>
			<input type="email" value="" data-msg-required="Your Email" maxlength="100" class="form-control" name="email" id="email">
		</div>
		<div class="form-group col-12">
			<label>Phone Number</label>
			<input type="text" value="" data-msg-required="Your Phone Number" maxlength="100" class="form-control" name="phone" id="phone">
		</div>
