...
<!-- <section class="section-allpage lazyload" data-bgset="https://gotra.sgp1.digitaloceanspaces.com/web-upload/1733983218-12-12-2024-gFUI80WA2RkbNn4ZzuVJyXh5pLaj9xlO.03
">
...
<div class="container-global">
	...
	<div class="title-product text-center mt-1">
        <span class="tag-atas">Contact Us</span>
        <h2>Get in Touch with <span>Success Trans Bali</span></h2>
    </div>
			...
			<div class="wrap-coninfo">
                ...
                <p>Follow us on Social Media</p>
                 <ul class="social-icons mt-3">
                    ...
                    <li class="social-icons-instagram"><a style="font-size: 17px;" href="https://api.whatsapp.com/send?phone=<?= $data->social->whatsapp ?>&text=Hello%2C%20I%20got%20this%20WhatsApp%20contact%20from%20the%20website%20https%3A%2F%2Fsuccesstransbali.com.%20I%20have%20a%20few%20questions%2C%20can%20you%20help%3F" target="_blank" title="Instagram"><i class="fab fa-whatsapp"></i></a></li>
               </ul>
			</div>
		</div>
