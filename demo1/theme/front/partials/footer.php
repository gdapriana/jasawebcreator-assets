    ...
    <div class="container-global pb-4 wow fadeInUp" style="position: relative; z-index: 3;">
        ...
        <div class="row justify-content-center wow fadeIn" data-wow-duration="2s">
            ...
            <div class="col-md-6 mb-4 mb-md-0">
                ...
                <p class="text-foot">Discover Bali with Bali Excited — personalized tours, local guides, and unforgettable experiences across Bali and Nusa Penida. Adventure, culture, and nature in one journey.</p>
