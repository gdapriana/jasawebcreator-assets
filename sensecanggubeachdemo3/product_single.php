            ...
            <div class="desc-single pt-0" style="border-top: none;">
                <div class="row mb-3">
                    ...
                    <div class="col-md-4 align-self-end">
                        <p class="review-at text-md-right"><i class="fas fa-star mr-2"></i> 4.7 <b style="color: black;">(100+ Review)</b> <span>100+ Booked</span></p>
                    </div>
                </div>
        ...
        <div class="row">
           ...
           <div class="wrap-single">
                <div class="desc-single pt-0" style="border-top: none;">
                    ...
                    <a class="btn btn-bok mt-0 mb-3 d-block d-md-none" href="#book">Book Now</a>

                    <?= $cutkonten[0]; ?>

                    <a class="btn btn-bok mb-5 mb-md-0 d-block d-md-none" href="#book">Book Now</a>
                </div>
 ...
 -->            
                ...
                <?php else: ?>
                    <div class="wrap-exbook mb-4">
                        ...
                        <a class="btn btn-exbook" href="https://api.whatsapp.com/send?phone=<?= $data->social->whatsapp?>&text=Hello%2C%20I%20got%20information%20from%20your%20website%20https%3A%2F%2Fwaterblowhuts.com%2F%20and%20I%20would%20like%20to%20book%20%2A<?= $data->result->title ?>%2A.%20Can%20you%20help%20me%20with%20that%3F">Book Now!</a>
