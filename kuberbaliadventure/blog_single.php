...
<section class="py-5 blogsing-style wow fadeIn" data-wow-duration="2s">
            ...
            <div class="col-md-8">
                ...
                <div class="row mb-3">
                    <div class="col-md-4 display-pc">
                        <div class="row">
                            <div class="col-md-4">
                                <img style="border-radius: 100px; border-radius: 100px; width: 60px; height: 60px; object-fit: cover;" alt="<?= $data->result->title ?> logo" class="img-fluid" src="<?= $data->web->site_logo ?>">
                            </div>
