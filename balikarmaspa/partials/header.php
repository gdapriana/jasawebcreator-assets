...
:root{
    ...
    --primtext: "Roboto Condensed", sans-serif;
    --subtext: "Roboto", sans-serif;
    --titletext: "Roboto Condensed", sans-serif;
}
...
@media (max-width: 768px) {
    ...
    .product .card .img {
        clip-path: polygon(100% 0, 100% 95%, 85% 100%, 0 95%, 0 0);
    }
    .product .card .day {
        font-size: 12px;
    }
    ...
    /* ======== Mob ======== */
    .product .mob .card-body {
        padding-bottom: 80px;
    }
    .product .mob .card img {
        height: 280px;
    }
    .product .mob .card .img {
        clip-path: polygon(100% 0, 100% 90%, 85% 100%, 0 90%, 0 0);
    }
    .product .mob .card .day {
        font-size: 15px;
    }
    .product .mob .card .location {
        font-size: 14px;
    }
    .product .mob .card h3 {
        font-size: 22px;
    ...
    .product .mob .card .price {
        font-size: 13px;
    }
    .product .mob .card .price span {
        font-size: 20px;
    }
    .product .mob .card .btn {
        font-size: 16px;
    }
}
/*=============== Product ===============*/
	...
	<div class="body">
        <header id="header" class="header-no-min-height <?= $data->site_position == "home" || $data->site_position == "view_product" ? ' header-transparent' : '' ?>" data-plugin-options="{'stickyEnabled': true, 'stickyEnableOnBoxed': true, 'stickyEnableOnMobile': true, 'stickyStartAt': 600, 'stickySetTop': '0'}">
                ...
                <style>
                  ...
                  <a class="btn btn-book-atas d-none d-md-block" href="<?= $func->dm_whatsapp() ?>">Booking Now!</a>
