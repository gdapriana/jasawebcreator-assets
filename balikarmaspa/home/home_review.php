    ...
    <div class="container-global wow fadeIn" wow-data-ruation="2s">
        ...
        <?php sort($item->data); foreach ($item->data as $items): ?>
            <div class="col-md-3 col-sm-4 col-6 px-md-2 px-1 pb-md-3 pb-2">
                ...
                <img src="https://jwc.gotra-resources.my.id/web-upload/1720689610-11-07-2024-EPbzukNpwDAvCQXFHLl0Te1sJdfc5MO7.webp" alt="google" class="logo-icon" />
                <div class="star my-2">
        ...
        <div class="text-center mt-5 rmr">
            ...
            <a class="btn btn-full mr-2" href="https://www.tripadvisor.com/Attraction_Review-g297701-d25039891-Reviews-Your_Bali_Taxi-Ubud_Gianyar_Regency_Bali.html">View All Reviews</a>
        </div>
