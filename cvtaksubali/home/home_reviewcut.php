        ...
        <div class="row">
            <div class="col-md-5 mb-md-0 mb-4 d-flex align-items-center">
                <div class="title-general">
                    <span class="tag-ats">Testimonials</span>
                    <h2 class="card-title text-light">What Our Guests Are Saying</h2>
                    <p class="">Discover why guests love <b>Sense Canggu Beach</b> from stunning rooms to exceptional service, our reviews reflect an unforgettable Bali experience.</p>
                    
                    <div class="pt-4">
                        <a href="#" class="btn-rev">View More Reviews</a>
                    </div>
                </div>
            </div>
